export const content = {
	cs: {
		...
		purpose: {
			header: 'Účel',
			body: [
				'Asociace je samosprávným, dobrovolným spolkem občanů a právnických osob. Účelem Asociace je zejména koordinace aktivit ukrajinských organizací v Jihočeském kraji, jejich zastřešení vůči správním a samosprávním orgánům, poskytování právního a účetního servisu svým členům, rozšíření možností svých členů k podpoře ukrajinské diaspory a lidí přicházejících z Ukrajiny, pomoc členům s realizací integračních aktivit do české společnosti. Účelem Asociace je umožnit svým členům rozšířit své aktivity k co největšímu množství příjemců. ',
				'Asociace zároveň vytváří podmínky a koordinuje aktivity svých členů např. zasílání humanitární pomoci na Ukrajinu, podpora finančních sbírek pro válečné uprchlíky a vybavení na frontu. ',
				' Asociace se hlásí k podpoře a rozvoji občanské společnosti, podpoře demokratických hodnot a šíření respektu v české společnosti. ',
				'Asociace spolupracuje s dalšími subjekty a organizacemi v Evropě na naplňování svého účelu. '
			]
		},
		subject: {
		...
		subjectBrief: {
			header: 'Poslání a cíle',
			list: [
				'Koordinace aktivit ukrajinských organizací v Jihočeském kraji.',
				'Poskytování právního a účetního servisu členům.',
				'Podpora humanitární pomoci a finanční podpory uprchlíkům.',
				'Podpora občanské společnosti a demokratických hodnot.',
				'Spolupráce na mezinárodní úrovni s evropskými organizacemi.'
			]
		},
		activities: {
			header: 'Aktivity',
			list: [
				'Koordinace ukrajinských iniciativ a tvorba platforem.',
				'Podpora členských organizací společnými akcemi a sdílením zdrojů.',
				'Vzdělávací programy včetně přednášek a kurzů.',
				'Humanitární a rozvojová pomoc.',
				'Rozvoj a podpora dobrovolníků.',
	...
	en: {
		...
		purpose: {
			header: 'Purpose',
			body: [
				'The Association is a self-governing, voluntary association of citizens and legal entities. The purpose of the Association is, in particular, the coordination of activities of Ukrainian organizations in the South Bohemian Region, their representation before administrative and self-governing bodies, providing legal and accounting services to its members, expanding the opportunities of its members to support the Ukrainian diaspora and people coming from Ukraine, and assisting members with the implementation of integration activities into Czech society. The purpose of the Association is to enable its members to expand their activities to as many recipients as possible. ',
				'The Association also creates conditions and coordinates the activities of its members, such as sending humanitarian aid to Ukraine, supporting financial collections for war refugees, and equipping the front lines. ',
				' The Association supports and develops civil society, supports democratic values, and spreads respect in Czech society. ',
				'The Association cooperates with other entities and organizations in Europe to fulfill its purpose. '
			]
		},
		subject: {
		...
		subjectBrief: {
			header: 'Mission and Goals',
			list: [
				'Coordination of activities of Ukrainian organizations in the South Bohemian Region.',
				'Providing legal and accounting services to members.',
				'Supporting humanitarian aid and financial assistance to refugees.',
				'Supporting civil society and democratic values.',
				'Cooperation at the international level with European organizations.'
			]
		},
		activities: {
			header: 'Activities',
			list: [
				'Coordination of Ukrainian initiatives and platform creation.',
				'Support of member organizations through joint events and resource sharing.',
				'Educational programs including lectures and courses.',
				'Humanitarian and developmental aid.',
				'Development and support of volunteers.',
	...
	uk: {
		...
		modal: {
			...
			header2: 'Витяг',
			header3:
				'зі спілкового реєстру, який веде крайовий суд у Чеських Будейовицях'
		},
		about: 'Про нас',
		name: {
			header: 'Назва',
		...
		purpose: {
			header: 'Мета',
			body: [
				'Асоціація є самоврядним, добровільним об’єднанням громадян та юридичних осіб. Метою Асоціації є, зокрема, координація діяльності українських організацій у Південночеському краї, їх представництво перед адміністративними та самоврядними органами, надання правових та бухгалтерських послуг своїм членам, розширення можливостей своїх членів для підтримки української діаспори та людей, які прибувають з України, допомога членам у реалізації інтеграційних заходів у чеське суспільство. Метою Асоціації є надання можливостей своїм членам розширювати свою діяльність для якомога більшої кількості отримувачів. ',
				'Асоціація також створює умови та координує діяльність своїх членів, наприклад, надсилання гуманітарної допомоги в Україну, підтримку фінансових зборів для військових біженців та забезпечення фронту. ',
				' Асоціація підтримує та розвиває громадянське суспільство, підтримує демократичні цінності та поширює повагу у чеському суспільстві. ',
				'Асоціація співпрацює з іншими суб’єктами та організаціями в Європі для досягнення своїх цілей. '
			]
		},
		subject: {
		...
		subjectBrief: {
			header: 'Місія та цілі',
			list: [
				'Координація діяльності українських організацій у Південночеському краї.',
				'Надання юридичних та бухгалтерських послуг членам.',
				'Підтримка гуманітарної допомоги та фінансова підтримка біженців.',
				'Підтримка громадянського суспільства та демократичних цінностей.',
				'Співпраця на міжнародному рівні з європейськими організаціями.'
			]
		},
		activities: {
			header: 'Діяльність',
			list: [
				'Координація українських ініціатив та створення платформ.',
				'Підтримка членів організацій через спільні заходи та обмін ресурсами.',
				'Освітні програми, включаючи лекції та курси.',
				'Гуманітарна та розвиткова допомога.',
				'Розвиток та підтримка волонтерів.',
				'Міжнародна співпраця та обміни.'
			]
		},
		contacts: {
